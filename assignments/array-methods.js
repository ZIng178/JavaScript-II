...
//PsuedoCode
//create an empty placeholder array to store the result ;
//Using forEach loop through the runners array 
// push the first name key value and last name key value in the placeholder array ;
//console.log (placeholder array )
...
// Using the map function push all the first name key values of the runners array .
//use the .toUppercase method on the pushed (current item) first name key value in to the placeholder array .
// console.log (placeholder array)

let firstNamesAllCaps = [];
runners.map(name=>firstNamesAllCaps.push(name.first_name.toUpperCase()));
...
runners.filter(function(size){
  if (size.shirt_size=='L'){
    runnersLargeSizeShirt.push(size)
  }
});
